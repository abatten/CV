...
\vspace{-1ex}
{\center \includegraphics[height=\fontcharht\font`\B]{images/icons/phone.png} \hspace{0.5ex} +613 9214 8746 \hspace{0.5ex} | \hspace{0.5ex} \includegraphics[height=\fontcharht\font`\B]{images/icons/github.png} \hspace{0.5ex} \href{https://github.com/abatten}{github.com/abatten} \hspace{0.5ex} | \hspace{0.5ex} \includegraphics[height=\fontcharht\font`\B]{images/icons/email.png} \hspace{0.5ex} abatten@swin.edu.au \hspace{0.5ex} | \hspace{0.5ex} \includegraphics[height=\fontcharht\font`\B]{images/icons/home.png} \hspace{0.5ex} \href{https://abatten.github.io}{abatten.github.io} \par}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%% EDUCATION %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\vspace{4ex}
{\centering \Large \textsc{Research Interests} \par}
\vspace{1ex}
{\centering Intergalactic Medium $\cdot$ Hydrodynamic Simulations $\cdot$ Metallicity \par} {\centering MUSE $\cdot$ Ly$\alpha$ emmiters $\cdot$ Fast Radio Bursts \par}
\vspace{3ex}
\noindent
...
%\noindent
%\textbf{Astronomy in the Park} \hfill 2019 - Present
%\setlist{nolistsep}
%\begin{itemize}[noitemsep]
%    \item 3D astronomy tours hosted by a resident 
%\end{itemize}
